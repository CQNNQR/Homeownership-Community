...
export const metadata: Metadata = {
  title: 'Contact Brandon Bee Dixon | Houston Mortgage Broker',
  description:
    'Get in touch with Brandon Bee Dixon — Houston mortgage broker (NMLS #1541210) and founder of The Homeownership Community. We respond within 24–48 hours.',
  alternates: {
  ...
  openGraph: {
    title: 'Contact Brandon Bee Dixon | Houston Mortgage Broker',
    description:
      'Get in touch with Brandon Bee Dixon — Houston mortgage broker (NMLS #1541210) and founder of The Homeownership Community.',
