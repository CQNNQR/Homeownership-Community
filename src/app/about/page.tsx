...
export const metadata = {
  title: 'About Brandon Bee Dixon | The Homeownership Community',
  description: 'Meet Brandon Bee Dixon - Mortgage Broker, Texas Realtor, author, and host of the Power of Ownership Podcast. With 30+ years of experience, Brandon helps families achieve homeownership and real estate investment goals.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block bg-red-700 text-white text-xs font-bold px-4 py-2 mb-6">
              I Create Owners
            </span>
            <h1 className="text-4xl md:text-5xl font-bold text-black mb-4">
              About Brandon Bee Dixon
            </h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block bg-black text-white text-xs font-bold px-4 py-2 mb-6">
            Podcast
          </span>
